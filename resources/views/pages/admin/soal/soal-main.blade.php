...
<main class="flex-1 p-6">
    <div class="w-full flex flex-row justify-between">
        <div class="font-bold">SOAL {{$respon['level']->nama_level}}</div>
        <div>
            <a href="{{ url('soal') }}" class="bg-red-500 text-white px-4 py-2 rounded text-xs mr-2">
...
<script>
    ...
    $(document).ready(function () {
        $('#table').DataTable({
            ...
            ajax: {
                url: "{{url('soal/'.$respon['id'].'/get-data')}}",
                type: 'GET',
            },
            columns: [
